...
<head>
    ...
    <title>Shop Bánh Kẹo Tết | TF</title>
    ...
    <link rel="stylesheet" href="./assets/font/fontawesome-free-5.15.1-web/fontawesome-free-5.15.1/css/all.min.css">
</head>
<body>
    <div class="warraper">
        <!-- Header -->
            ...
            <div class="grid wide">
                ...
                <div class="header__menu ">
                    <ul class="header__list-bottom ">
                        <li class="header__item-bottom hidden-on-mobile ">
                            <a href="" class="header__item-link ">Sản Phẩm Bán Chạy</a>
                        </li>
                        <li class="header__item-bottom hidden-on-mobile ">
                            <a href="" class="header__item-link  ">Hộp Quà Tết</a>
                        </li>
                        <li class="header__item-bottom hidden-on-mobile hidden-on-mobile-and-table">
                            <a href="" class="header__item-link">Giỏ Tết</a>
                        </li>
                        <li class="header__item-bottom  hidden-on-mobile hidden-on-mobile-and-table">
                            <a href="" class="header__item-link">Giỏ Trái Cây</a>
                        </li>
                        <li class="header__item-bottom hidden-on-mobile  hidden-on-mobile-and-table">
                            <a href="" class="header__item-link">Sản Phẩm Khác</a>
                        </li>
            ...
            <div class="grid">
                <div class="slider ">
                    <div class="owl-carousel owl-theme">
                        <div class="item">
                            <img src="./assets/image/bannerso1.jpg" alt="">
                        </div>
                        <div class="item">
                ...
                <div class="row content__banner">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <a href="" class="banner__link">
                                    <img src="./assets/image/Untitled-1.png" alt="" class="banner__img">
                                    <p class="banner__text"> Hộp Quà Tết</p>
                                </a>
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <a href="" class="banner__link">
                                    <img src="./assets/image/Untitled-2.png" alt="" class="banner__img">
                    ...
                    <div class=" col-lg-3 col-md-3 col-sm-12 content__baner-img">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <a href="" class="banner__link">
                                    <img src="./assets/image/Untitled-3.png" alt="" class="banner__img">
                                    <p class="banner__text"> Giỏ Trái Cây</p>
                                </a>
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <a href="" class="banner__link">
                                    <img src="./assets/image/Untitled-4.png" alt="" class="banner__img">
                    ...
                    <div class=" col-lg-6 col-md-6 col-sm-12 content__baner-img-lg">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                            <a href="" class="banner__link"> <img src="./assets/image/banner.png" alt="" class="banner__img">
            ...
            <div class="grid wide">
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="card">
                            <a href="" class="card-link">
                                <div class="card-content" style="background-image: url(./assets/image/hq3.jpg) ;"> 
                                    <div class="card-body">
                                        <h3 class="card-name">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="card">
                            <a href="" class="card-link">
                                <div class="card-content" style="background-image: url(./assets/image/hq2.jpg) ;"> 
                                    <div class="card-body">
                                        <h3 class="card-name">
                                            Hộp Quà Tết 2021 (Mẫu 1)
                                        </h3>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="card">
                            <a href="" class="card-link">
                                <div class="card-content" style="background-image: url(./assets/image/hq4.jpg) ;"> 
                                    <div class="card-body">
                                        <h3 class="card-name">
                                            Hộp Quà Tết 2021 (Mẫu 1)
                                        </h3>
            ...
            <div class="grid wide">
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="card">
                            <a href="" class="card-link">
                                <div class="card-content" style="background-image: url(./assets/image/tc1.png) ;"> 
                                    <div class="card-body">
                                        <h3 class="card-name">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="card">
                            <a href="" class="card-link">
                                <div class="card-content" style="background-image: url(./assets/image/tc2.png) ;"> 
                                    <div class="card-body">
                                        <h3 class="card-name">
                                            Giỏ trái cây 2 (Mẫu 1)
                                        </h3>
                                        <p class="card-price">
                                            65,000$ <span> 68,000$</span>
                                        </p>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="card">
                            <a href="" class="card-link">
                                <div class="card-content" style="background-image: url(./assets/image/tc3.png) ;"> 
                                    <div class="card-body">
                                        <h3 class="card-name">
                                            Giỏ trái cây 3 (Mẫu 1)
                                        </h3>
                                        <p class="card-price">
                                            65,000$ <span> 68,000$</span>
                                        </p>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="card">
                            <a href="" class="card-link">
                                <div class="card-content" style="background-image: url(./assets/image/tc4.png) ;"> 
                                    <div class="card-body">
                                        <h3 class="card-name">
                                            Giỏ trái cây 4 (Mẫu 1)
                                        </h3>
                                        <p class="card-price">
                                            65,000$ <span> 68,000$</span>
                                        </p>
            ...
            <div class="grid wide">
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="card">
                            <a href="" class="card-link">
                                <div class="card-content" style="background-image: url(./assets/image/gq4.png) ;"> 
                                    <div class="card-body">
                                        <h3 class="card-name">
                                            Giỏ trái cây 1 (Mẫu 1)
                                        </h3>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="card">
                            <a href="" class="card-link">
                                <div class="card-content" style="background-image: url(./assets/image/gq3.png) ;"> 
                                    <div class="card-body">
                                        <h3 class="card-name">
                                            Giỏ trái cây 2 (Mẫu 1)
                                        </h3>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="card">
                            <a href="" class="card-link">
                                <div class="card-content" style="background-image: url(./assets/image/gq2.jpg) ;"> 
                                    <div class="card-body">
                                        <h3 class="card-name">
                                            Giỏ trái cây 3 (Mẫu 1)
                                        </h3>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="card">
                            <a href="" class="card-link">
                                <div class="card-content" style="background-image: url(./assets/image/gq1.jpg) ;"> 
                                    <div class="card-body">
                                        <h3 class="card-name">
                                            Giỏ trái cây 4 (Mẫu 1)
                                        </h3>
            ...
            <div class="grid wide">
                <div class=" row content__news">
                    <div class="col-lg-4 ">
                        <div class="card ">
                            <a href="" class="card-link">
                                <div class="card-content content__news-card" style="background-image: url(./assets/image/bn1.jpg) ;"> 
                    ...
                    <div class="col-lg-4 ">
                        <div class="card ">
                            <a href="" class="card-link">
                                <div class="card-content content__news-card" style="background-image: url(./assets/image/bn3.png) ;"> 
                                    <div class="content__news-body">
                                        <h3 class="card__news-name">
                                            Hướng dẫn việc tặng quà lễ, tết các đối tượng chính sách
                                        </h3>
                    ...
                    <div class="col-lg-4 ">
                        <div class="card ">
                            <a href="" class="card-link">
                                <div class="card-content content__news-card" style="background-image: url(./assets/image/bn2.jpg) ;"> 
                                    <div class="content__news-body">
                                        <h3 class="card__news-name">
                                            Hướng dẫn việc tặng quà lễ, tết các đối tượng chính sách
                                        </h3>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="footer__contact">
                            ...
                            <img src="./assets/image/logo (1).png" alt="" class="footer__link-img">
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="footer__contact">
